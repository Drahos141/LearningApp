...
const QUESTIONS = [
  ...
  { q: 'A shape has 5 faces, 5 vertices, and 8 edges. What is it?', answer: 'Square pyramid', options: ['Tetrahedron','Cube','Triangular prism','Square pyramid'], exp: 'Square pyramid: 5 faces (1 square base + 4 triangular sides), 5 vertices, 8 edges. Euler\'s formula: V-E+F = 5-8+5 = 2 ✓' },
